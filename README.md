...
⚠️ **注意**: 現在のシステムはGoogle Analyticsを使用しません。シンプルで軽量な構成になっています。
...
### v2.1.0 (2025-08-20) - 🎯 UX・表示改善アップデート
- 🎯 **選択肢統一**: ワークショップ・プラネタリウム選択を「はい/いいえ」に統一
- 📊 **残席表示改善**: 具体的な残席数から「残席あり/残席なし」の2値表示に変更
- 👁️ **全選択肢表示**: 残席なし・残席不足の時間帯もグレーアウトで表示
- 🔒 **アクセシビリティ向上**: 選択不可選択肢の明確な視覚的フィードバック
- 📈 **Google Analytics削除**: シンプルなシステム構成に最適化
- 🛡️ **セキュリティ設定最適化**: GitHubページ環境に適した設定調整
